...
class DepositPage:
    def __init__(self, driver):
        ...
        self.description_field = (By.NAME, "desc")  # Thêm trường Description
    ...
    def enter_description(self, description):
        self.driver.find_element(*self.description_field).send_keys(description)  # Thêm hàm nhập Description
